  ...
  return (
    <div className="flex flex-col items-center justify-center mb-10">
      ...
      <div className="padding-container max-container w-800 bg-gray-90 rounded-2xl pb-10 pt-10 mt-5 mb-5">
        ...
        <Image src="/Marquee_WFL.png" width={300} height={150} />
    ...
    <section className="flexCenter flex-col">
      <div className="padding-container max-container w-800 bg-gray-90 rounded-2xl pb-10 pt-10 mt-5 mb-5">
        <div className="flex flex-wrap justify-between lg:gap-10">
        <Image src="/Marquee_CFL.png" width={300} height={150} />
    ...
    <section className="flexCenter flex-col">
      <div className="padding-container max-container w-800 bg-gray-90 rounded-2xl pb-10 pt-10 mt-5 mb-5">
        <div className="flex flex-wrap justify-between lg:gap-10">
        <Image src="/Marquee_RFL.png" width={300} height={150} />
    ...
    <section className="flexCenter flex-col">
      <div className="padding-container max-container w-800 bg-gray-90 rounded-2xl pb-10 pt-10 mt-5 mb-5">
        <div className="flex flex-wrap justify-between lg:gap-10">
        <Image src="/Marquee_EFL.png" width={300} height={150} />
