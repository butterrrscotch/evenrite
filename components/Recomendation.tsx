...
const EventRecomendation = () => {
  // Define an array of recommended events (sample data)
  ...
  return (
    <section className="py-12">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        {/* Map over the recommendedEvents array to render each event recommendation */}
        {recommendedEvents.map((event, index) => (
          <div key={index} className="flex flex-col rounded-md border border-gray-300 p-5">
            ...
            {/* Event title wrapped in Link component */}
